...
// version 1.5.101207
// Adapted to Magento and a few new features: Gabriel Somoza (me@gabrielsomoza.com)
    ...
    $.fn.infinitescroll = function(options,callback){
        ...
        function kickOffAjax(){
            ...
            props.loadingMsg.appendTo( opts.loadMsgSelector ).show(opts.loadingMsgRevealSpeed, function(){
                ...
                $.get( desturl,null,loadCallback);
            });

        }

        function loadCallback(data, textStatus, request){
            opts.dataCallback.call(opts, data, textStatus, request);
            ...
            if (opts.isDone){
                ...
                box = $(opts.itemSelector, data).parent();
        ...
        .bind('error.infscr.'+opts.infid, function(event,errorStatus) {
